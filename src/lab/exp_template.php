...
<!-- The lab Header contains the logo and the name of the lab,
	...
	<div class="breadcrumb" id="experiment-article-breadcrumb"><a href="<?php echo $vlab_url?>">Home</a><a></a> &gt; <a href="<?php echo $lab_url?>">Basic Structural Analysis</a>    </div>
	...
	<section id="experiment-article-section-1">
		...
		<!-- Enclose the icon image of your lab -->
		<img src="http://deploy.virtual-labs.ac.in/labs/cse29/images/introduction.jpg">
		</div>	
  ...
  footer-->
   <footer id="lab-footer" class="footer">
	...
	<a href="http://virtual-labs.ac.in/nmeict/">Sponsered by MHRD (NME-ICT) </a> | <a href="http://virtual-labs.ac.in/licensing/" target="_blank"> Licensing Terms </a> | <a href="http://virtual-labs.ac.in/feedback/?lab=eerc04/" target="_blank"> Feedback </a>
  </footer>
