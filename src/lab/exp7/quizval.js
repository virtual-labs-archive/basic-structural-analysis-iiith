...
function checkQuiz() {
    ...
    numCorrect += checkQuestionRadio(document.getElementById("q5"));

    numCorrect += checkQuestionRadio(document.getElementById("q6"));


    numCorrect += checkQuestionRadio(document.getElementById("q7"));
